...
// noinspection SpellCheckingInspection
const nsisPathPromise = (0, (_binDownload || _load_binDownload()).getBinFromBintray)("nsis", "3.0.1.13", "2921dd404ce9b69679088a6f1409a56dd360da2077fe1019573c0712c9edf057");
// noinspection SpellCheckingInspection
        ...
        return (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
            ...
            if (options.menuCategory != null && options.menuCategory !== false) {
                ...
                if (options.menuCategory === true) {
                    menu = (0, (_sanitizeFilename || _load_sanitizeFilename()).default)(packager.appInfo.companyName);
                } else {
